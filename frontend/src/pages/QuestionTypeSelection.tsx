...
export default function QuestionTypeSelection() {
  ...
  return (
    <div style={{ padding: "40px 20px", backgroundColor: colors.bg, minHeight: "100vh", color: colors.text }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "10px" }}>Select Question Type</h1>
        <p style={{ color: colors.textSec, marginBottom: "40px", fontSize: "1.1rem" }}>
          ...
          {options.map((opt) => (
            ...
            >
              ...
              <div style={{ 
                ...
                backgroundColor: opt.bg, color: opt.color, fontSize: "1.8rem",
                display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px"
              }}>
                {opt.title.split(" ")[0]} 
              </div>
              
              <h3 style={{ fontSize: "1.25rem", fontWeight: "bold", marginBottom: "10px", color: colors.text }}>
                {opt.title.substring(2)}
              </h3>
              
              <p style={{ color: colors.textSec, fontSize: "0.95rem", lineHeight: "1.6" }}>
                {opt.desc}
              </p>
            </div>
          ))}
