  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <h1 style={{ color: colors.text, margin: 0 }}>
              Teacher Dashboard
            </h1>
        ...
        >
          ...
          >
            ...
            <span style={{ color: colors.accentText, fontSize: "0.9rem" }}>
              Define topics & generate a test
            </span>
          </button>
          ...
          <button
            ...
            style={{
              ...
              border: `2px dashed ${colors.successBorder}`,
              borderRadius: "12px",
              cursor: "pointer",
              display: "flex",
              flexDirection: "column",
        ...
        <div>
          ...
          {loading && (
            <p style={{ color: colors.textSec }}>Loading your exams...</p>
          )}
          ...
          >
            {tests.map((test) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      padding: "2px 6px",
                      borderRadius: "4px",
                      backgroundColor: test.is_published
                        ? colors.successBg
                        : colors.neutralBg,
                      color: test.is_published
                        ? colors.successText
                        : colors.neutralText,
                    }}
                  >
                ...
                >
                  {test.question_count} Questions &bull; {test.total_points}{" "}
                  Points
                </p>
              </div>
            ))}
