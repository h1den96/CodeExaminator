...
exports.ExamManagementService = void 0;
...
class ExamManagementService {
        ...
        try {
         ...
         RETURNING question_id`, [
            ...
            if (dto.question_type === "mcq" && dto.options) {
             ...
             VALUES ($1, $2, $3, $4)`, [qId, opt.text, opt.is_correct, opt.is_correct ? 1.0 : 0.0]);
                }
            }
            else if (dto.question_type === "true_false" &&
           ...
           VALUES ($1, $2)`, [qId, dto.correct_answer]);
                ...
                await client.query(`INSERT INTO exam.programming_questions (question_id, starter_code, test_cases)
           VALUES ($1, $2, $3)`, [qId, dto.starter_code || "", JSON.stringify(dto.test_cases || [])]);
            }
    ...
    `;
        ...
        const res = await db_1.examDb.query(sql, values);
        return res.rows[0];
    }
...
exports.ExamManagementService = ExamManagementService;
