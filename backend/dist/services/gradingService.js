...
class GradingService {
     ...
     * 📊 CALCULATE MCQ SCORE
     */
    static calculateMCQ(maxPoints, options, selectedIds, enableNegative) {
        ...
        if (finalScore < 0)
            return enableNegative ? finalScore : 0;
        return parseFloat(finalScore.toFixed(2));
    }
    /**
     * ✅ CALCULATE TRUE/FALSE SCORE
     */
    static calculateTrueFalse(maxPoints, studentAnswer, correctAnswer) {
     ...
     */
    static performStaticAnalysis(code, forbidden = [], required = []) {
     ...
     */
    static smartCompare(actual, expected) {
